    ...
    <header className="h-16 bg-white border-b border-slate-200 px-3 sm:px-6 flex items-center justify-between shadow-xs z-20">
      ...
      <form onSubmit={handleQuickTrack} className="flex items-center gap-3 flex-1 max-w-md">
        <div className="relative w-full">
          ...
          <input
            ...
            className="w-full ps-9 pe-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-[#169C47] focus:border-transparent transition-all"
          />
        </div>
      </form>
      ...
      <div className="flex items-center gap-2 sm:gap-3 ms-2 sm:ms-4">
        ...
        <button
          ...
          className="flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-3 py-1.5 bg-emerald-50 hover:bg-emerald-100 text-[#169C47] rounded-xl text-xs font-bold transition-all border border-emerald-200/60 shadow-2xs"
        ...
        <div className="flex items-center gap-2.5 ps-2 border-s border-slate-200">
          <div className="w-8 sm:w-9 h-8 sm:h-9 rounded-xl bg-gradient-to-tr from-[#169C47] to-emerald-400 text-white font-bold flex items-center justify-center text-xs shadow-sm">
            AD
          </div>
